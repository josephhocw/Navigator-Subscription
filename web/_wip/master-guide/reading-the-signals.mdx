...
In other words, the entry zone and the same take-profit and stop structure as the [trade setups](/guides/master/trade-setups). The sell-zone signals mirror it on the way down.
