...
This is your reference manual for the chart. Once the Navigator is attached, the screen fills with lines, labels and panels. This page explains what each one means. When you're ready to trade with them, move on to [the trade setups](/guides/master/trade-setups).
...
<GuideShot src="/learn/understanding/overview.png" caption="The current channel in blue, the previous one faded green behind it, the two moving averages following the bars, and the Trend Analysis panel in the corner." />
...
<GuideShot src="/learn/understanding/channel-lines.png" caption="The full set: resistance and support with the dashed middle line between them, the extended resistance above (red) and the extended support below (green)." />
...
<GuideShot src="/learn/understanding/second-extended-line.png" caption="Price kept sliding past the extended support, so a second one appeared: the ES2 labels." />
...
<GuideShot src="/learn/understanding/extended-signal-second-hit.png" caption="Labels printing as events trigger. Bottom right: the extended support takes a second hit (ES), price rebounds, and an extended buy (EB) prints." />
